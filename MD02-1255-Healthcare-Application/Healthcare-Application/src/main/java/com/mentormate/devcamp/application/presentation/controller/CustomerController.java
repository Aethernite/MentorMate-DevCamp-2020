...
import com.mentormate.devcamp.application.business.service.CustomerService;
...
@RestController
@RequestMapping("/api/v1/customers/doctors")
public class CustomerController {
    ...
    public ResponseEntity<Page<FullDoctorDTO>> getAllDoctors(@RequestParam("page") int page) {
        return new ResponseEntity<>(customerService.findPaginated(page), HttpStatus.OK);
    }
