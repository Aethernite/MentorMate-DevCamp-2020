...
public class AppointmentController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "500", description = "Internal Server Error")})
    @GetMapping(path = "/me", params = {"page"})
    public ResponseEntity<Page<FullAppointmentDTO>> getAllAppointments(@RequestParam("page") int page) {
        return new ResponseEntity<>(appointmentService.findPaginatedForMe(page), HttpStatus.OK);
    }
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Appointment not found"),
            @ApiResponse(responseCode = "500", description = "Internal Server Error")})
    @PutMapping("/set/{appointmentId}")
    public ResponseEntity<FullAppointmentDTO> setPendingId(@PathVariable("appointmentId") @Min(value = 1) @NotNull Long appointmentId, @RequestParam("status") String status) {
        return new ResponseEntity<>(appointmentService.changeAppointmentStatus(appointmentId, status), HttpStatus.OK);
    }
